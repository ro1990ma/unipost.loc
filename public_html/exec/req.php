...
//                             echo "<h1>".$this->params->get('kol_mest').$count_mest_def."ddd</h1>";
                                        ?>
                                        <tr>
						<td><p><?php echo JText::_('COL_MEST'); ?></p></td>
                                                
						<td colspan="1"><select class="calc_size_lenght" id="calc_size_lenght" name="calc_size_lenght">
                                                        <?php 
//                                                        $count_mest=4;
...
<!--                                                <td colspan="1"><input class="radio" type="radio" value="1" name="calc_size_width" checked="true" /><p><?php echo JText::_('UPAKOVANI'); ?></p>
					...
					<tr>
						<td><p><?php echo JText::_('GABARITI'); ?></p></td>
						<td colspan="3"><input class="short" type="text" id="len" placeholder=" <?php echo JText::_('LENGHT'); ?>" name="calc_size_lenght_gab" /> x <input class="short" id="wid" type="text" placeholder="<?php echo JText::_('WIDTH'); ?>" name="calc_size_width_gab" /> x <input class="short" id="hei" type="text" placeholder="<?php echo JText::_('HEIGHT'); ?>" name="calc_size_height_gab" /></td>
					</tr>
<!--					<tr>
						<td><p><?php echo JText::_('CONTACT_PERSSON_FIELD'); ?></p></td>
					...
					<tr>
						<td><p><?php echo JText::_('OPISANIE_SODERJANIE'); ?></p></td>
