...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<span id="btl-panel-profile" class="btl-dropdown">
			<?php
			echo JText::_("LOGIN_TO_YOUR_ACCOUNT");
			?>
		</span> 
		<?php else : ?>
			<!-- Login button -->			
			<span id="btl-panel-login" class="<?php echo $effect;?>"><?php echo JText::_('LOGIN_TO_YOUR_ACCOUNT');?></span>
	...
	<div id="btl-content">
		...
		<div id="btl-content-profile" class="btl-content-block">
			...
			<?php endif; ?>
			<div class="btl-field">
						<div class="btl-label"><a class="login_bt" href="<?php echo JRoute::_('index.php?option=com_users&view=profile', false); ?>"><?php echo JText::_('YOUR_CONTROL_PANEL'); ?></a></div>
			</div>
			<?php if($showLogout == 1):?>
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<form name="btl-formlogin" class="btl-formlogin" action="<?php echo JRoute::_('index.php?option=com_users&view=profile', true, $params->get('usesecure')); ?>" method="post">
