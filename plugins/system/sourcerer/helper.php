...
class plgSystemSourcererHelper
{
	...
	{
		NNFrameworkFunctions::protectForm( $string, array( $this->src_params->syntax_start, $this->src_params->syntax_start_0, $this->src_params->syntax_end ) );
	}

	function unprotect( &$string )
	{
		NNFrameworkFunctions::unprotectForm( $string, array( $this->src_params->syntax_start, $this->src_params->syntax_start_0, $this->src_params->syntax_end ) );
	}
